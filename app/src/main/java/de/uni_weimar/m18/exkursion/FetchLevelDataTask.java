...
class FetchLevelDataTask extends AsyncTask<Void, Integer, Void> {
    ...
    private void syncFiles(FileListJSON fileList) {
            ...
            while(filesCursor.moveToNext()) {
                ...
                if(!remoteFiles.contains(local_filename)) {
                    ...
                    if(rowsDeleted > 0) {
                        ...
                        Log.v(LOG_TAG, "Deleted " + Integer.toString(rowsDeleted) + " files rows (" + local_filename +")");
                    } else {
        ...
        for(FileListJSON.FileJSON file : files) {
            ...
            if(filesCursor.moveToFirst() // File is in table
                ...
                //fileList_for_download.add(new File(base_path + "/" + file.filepath + "/" + file.filename));
    ...
    private void downloadAndStoreFile(FileListJSON.FileJSON fileJSON, String base_path,
        ...
        try {
            ...
            File rootDir = new File(mDownloadFragment.getActivity().getExternalFilesDir(null) + "/" + base_path);
            ...
            if(!downloadFolder.exists() || !downloadFolder.isDirectory()) {
                if(!downloadFolder.mkdirs()) {
                    ...
                    throw new IOException("Creation of download folder " + downloadFolder.toString() + "failed");
                }
            }
